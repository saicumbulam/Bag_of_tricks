...
description: Create software diagrams using Mermaid text-based syntax — class diagrams, sequence diagrams, flowcharts, ERDs, C4 architecture diagrams, state diagrams, git graphs, and more. Use when the user asks to diagram, visualize, model, map out, or show the flow of a system.
---
...
1. Identify the diagram type needed (see the selection table below).
2. Load the matching reference file from `references/` for detailed syntax, examples, and patterns.
3. Start with a minimal diagram, then add detail incrementally.
4. Validate output mentally against the "NEVER Do" rules at the bottom before returning it.
...
| State Diagrams | State machines, lifecycle states | (covered in advanced-features) |
| Git Graphs | Branching strategies | (covered in advanced-features) |
| Gantt Charts | Project timelines, scheduling | (covered in advanced-features) |

**For styling, themes, and layout options:** `references/advanced-features.md`
...
3. **Comment extensively** — use `%%` to explain complex relationships.
...
See `references/advanced-features.md` for full theming details.

## Rendering and Export

**Native support in:** GitHub/GitLab (Markdown), VS Code (with Mermaid extension), Notion, Obsidian, Confluence.
